...
public class PolyPainter extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) {
		...
		// RectangleThings:
		shapes[0] = new RectangleThing(rand.nextInt(width), rand.nextInt(height),
				rand.nextInt(width/2), rand.nextInt(height/2), Color.black);
		shapes[1] = new RectangleThing(rand.nextInt(width), rand.nextInt(height),
				rand.nextInt(width/2), rand.nextInt(height/2), Color.yellow);
		
		// RoundThings: TODO
		
		// FilledRectangleThings:
		shapes[2] = new FilledRectangleThing(rand.nextInt(width), rand.nextInt(height),
				rand.nextInt(width/2), rand.nextInt(height/2), Color.white, Color.blue);
